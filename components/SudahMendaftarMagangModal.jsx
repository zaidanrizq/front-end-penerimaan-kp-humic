...
const SudahMendaftarMagangModal = ({show, onEdit, onBatal, onClose}) => {
    if (!show) {
        return null;
    }
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="flex flex-col justify-center items-center bg-white rounded-xl gap-[8px] w-[32%]">
                ...
                <div className="flex flex-col justify-center text-center font-inter items-center gap-[8px] mb-[32px]">
                    <FaTriangleExclamation className="w-[64px] h-[64px] text-primary	"/>
                    <h2 className="font-bold text-[20px mt-[16px]">User Sudah Mendaftar</h2>
                    <p className="font-normal text-[16px] mb-[8px] w-[400px]">Pergi ke halaman Ubah Profile jika ingin menarik kembali lamaran Anda!</p>
...
export default SudahMendaftarMagangModal